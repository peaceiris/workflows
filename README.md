...
jobs:
  test:
    ...
    steps:
      ...
      - uses: peaceiris/workflows/setup-docker@v0.21.6
...
jobs:
  test:
    ...
    steps:
      ...
      - uses: peaceiris/workflows/setup-go@v0.21.6
        with:
          go-version: '1.18'
...
jobs:
  test:
    ...
    steps:
      ...
      - uses: peaceiris/workflows/setup-node@v0.21.6
        with:
...
jobs:
  test:
    ...
    steps:
      ...
      - uses: peaceiris/workflows/setup-python@v0.21.6
        with:
          python-version: '3.10'
...
jobs:
  test:
    ...
    steps:
      ...
      - uses: peaceiris/workflows/setup-rust@v0.21.6
```
...
jobs:
  test:
    ...
    steps:
      ...
      - uses: peaceiris/workflows/setup-goreleaser@v0.21.6
...
jobs:
  test:
    ...
    steps:
      ...
      - uses: peaceiris/workflows/setup-ko@v0.21.6
...
jobs:
  test:
    ...
    steps:
      ...
      - uses: peaceiris/workflows/setup-mage@v0.21.6
...
jobs:
  hadolint:
    uses: peaceiris/workflows/.github/workflows/hadolint.yml@v0.21.6
```
...
jobs:
  actionlint:
    uses: peaceiris/workflows/.github/workflows/actionlint.yml@v0.21.6
```
...
jobs:
  merger:
    uses: peaceiris/workflows/.github/workflows/merger.yml@v0.21.6
```
