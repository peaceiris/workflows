...
jobs:
  test:
    ...
    steps:
      ...
      - uses: peaceiris/workflows/setup-docker@v0.20.0
...
jobs:
  test:
    ...
    steps:
      ...
      - uses: peaceiris/workflows/setup-node@v0.20.0
        with:
...
jobs:
  test:
    ...
    steps:
      ...
      - uses: peaceiris/workflows/setup-python@v0.20.0
        with:
          python-version: '3.10'
...
jobs:
  test:
    ...
    steps:
      ...
      - uses: peaceiris/workflows/setup-rust@v0.20.0
```
...
jobs:
  test:
    ...
    steps:
      ...
      - uses: peaceiris/workflows/setup-goreleaser@v0.20.0
...
jobs:
  test:
    ...
    steps:
      ...
      - uses: peaceiris/workflows/setup-mage@v0.20.0
...
jobs:
  merger:
    uses: peaceiris/workflows/.github/workflows/merger.yml@v0.20.0
```
